...
def E(i):
    ...
    return(3e+7*fr*eTime*N0*fe*rhoDM/nj/mH*(sigmavSi*mSi/Si/pASi+sigmavHg*mHg/Hg/pAHg+sigmavTe*mTe/Te/pATe))
...
if __name__ == '__main__':  
    ...
    for i in range(28):
        ...
        savet.append([v0,si0]+Ei)
    np.savetxt('sigma-v0_body(mH=1.5).dat',savet)
